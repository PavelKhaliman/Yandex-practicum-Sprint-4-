...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	metresSec := meanSpeed(action, duration) * kmhInMsec // скорость в метрах в секунду
	heightMetres := height / cmInM                       // рост в метрах
	spentCalories := ((walkingCaloriesWeightMultiplier*weight + (math.Pow(metresSec, 2)/heightMetres)*
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	spentCalories := ((swimmingMeanSpeed(lengthPool, countPool, duration) + swimmingCaloriesMeanSpeedShift) *
